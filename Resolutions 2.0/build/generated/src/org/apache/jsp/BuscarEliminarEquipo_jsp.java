...
public final class BuscarEliminarEquipo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <h2 class=\"pageheader-title\">Insertar Equipos</h2>\n");
      ...
      out.write("                                        <li class=\"breadcrumb-item active\" aria-current=\"page\">Buscar y Eliminar Equipos</li>\n");
      out.write("                                    </ol>\n");
      out.write("                                </nav>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      ...
      out.write("                                <h5 class=\"card-header\">Buscar y Eliminar Equipo</h5>\n");
      ...
      out.write("                                                <th scope=\"col\">Identificación Equipo</th>\n");
      out.write("                                                <th scope=\"col\">Identificación Cliente</th>\n");
      out.write("                                                <th scope=\"col\">Identificación Estado</th>\n");
      ...
      out.write("                                            ");
                                                ...
                                                EquipoDAO cliDAO = new EquipoDAO();
                                                ArrayList<EquipoVO> listar = cliDAO.listar();
                                                if (listar.size() == 0) {
      ...
      out.write("</td>\n");
      out.write("                                                <td>                                                    \n");
      out.write("                                                    <form method=\"post\" action=\"EquipoControlador\">\n");
      out.write("                                                        <input type=\"hidden\" name=\"txtIdEq\" value=\"");
      out.print( cliVO.getIdEq());
      out.write("\">\n");
      ...
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print( cliVO.getIdEqCli());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print( cliVO.getIdEqEst());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print( cliVO.getNombreEq());
      out.write("</td>\n");
      out.write("                                                <td>");
      out.print( cliVO.getInventarioEq());
      out.write("</td>                                                \n");
      out.write("                                                <td>");
      out.print( cliVO.getMarcaEq());
      out.write("</td>                                                \n");
      out.write("                                                <td>");
      out.print( cliVO.getSerieEq());
      out.write("</td>                                                \n");
      out.write("                                                <td>");
      out.print( cliVO.getUbicacionEq());
      out.write("</td>                                                \n");
      out.write("                                            </tr>\n");
      out.write("                                            ");
