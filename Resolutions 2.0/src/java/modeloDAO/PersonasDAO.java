...
public class PersonasDAO extends ConexionBD implements InterfaceCRUD{
    ...
    public boolean insertarRegistro() {
        ...
        try {
            puente.executeUpdate("INSERT INTO PERSONAS (IDPER, IDUSU, TIPOPER, NOMBREPER, APELLIDOPER, TIPODOCUMENTOPER, IDENTIFICACIONPER, CORREOPER) VALUES ('"+idPer+"', '"+idUsu+"', '"+tipoPer+"', '"+nombrePer+"', '"+apellidoPer+"', '"+tipoDocumentoPer+"', '"+identificacionPer+"', '"+correoPer+"');");
            operacion = true;
    ...
    public boolean actualizarRegistro() {
        ...
        try {
            puente.executeUpdate("UPDATE PERSONAS SET IDUSU = '"+idUsu+"', TIPOPER = '"+tipoPer+"', NOMBREPER = '"+nombrePer+"', APELLIDOPER = '"+apellidoPer+"', TIPODOCUMENTOPER = '"+tipoDocumentoPer+"', IDENTIFICACIONPER = '"+identificacionPer+"', CORREOPER = '"+correoPer+"';");
            operacion = true;
        } catch (Exception e) {
    ...
    public static PersonasVO buscarRegistro(String idPer) {
