...
public class PropiedadesCorreo {
    public static void envioCorreo(String host, String puerto, final String usuario, final String clave, String direccionDestino, String asunto, String mensaje)
    throws AddressException, MessagingException 
    {
        ...
        InternetAddress[] direcciones = {new InternetAddress(direccionDestino)};
