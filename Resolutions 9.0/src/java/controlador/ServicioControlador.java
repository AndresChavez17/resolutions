    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(cuenta==null){
                ...
                String estEq = request.getParameter("estEq");
                ...
                switch(seleccion){
                    ...
                    case "insertar":
                        ...
                        if(eqDAO.estadoServicio(estEq, idEq)){
                            
                        }else{
                            serDAO.eliminarRegistro();
                            mensaje = "No se pudo ingresar el servicio";
                        }
                    ...
                    case "modificar":
                        ...
                        serVO = new ServicioVO(idSer, idPer, idEq, fechaIngresoSer, fechaEntregaSer, observacionesSer);
                        serDAO = new ServicioDAO(serVO);
                        if(equDAO.estadoServicio(estEq, idEq)){
