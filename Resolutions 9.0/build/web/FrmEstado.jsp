                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    %>
                                    <div id="cajon1">
                                    <form id="validationform" data-parsley-validate="" novalidate="" method="post" action="Estado">                                        
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Nombre del Estado *</label>
                                        <div class="col-12 col-sm-8 col-lg-6">                                             
                                            <input type="text" required="" data-parsley-maxlength="15" placeholder="Ingrese el Nombre" class="form-control" name="nombreEst" autofocus="">                                            
                                        </div>
                                        </div>
                                        <div class="form-group row text-right">
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                <input type="hidden" name="seleccion" value="insertar">
                                                <input class="btn btn-space btn-primary" type="submit" value="Insertar Estado">
                                            </div>
                                        </div>                                        
                                    </form>
                                    </div>
                                    <div id="cajon2">
                                        <form method="post" action="Estado">
                                            ...
                                            <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                                ...
                                                <input class="btn btn-space btn-primary" type="submit" value="Actualizar Estado">
                                    ...
                                    <div class="card-body">
                                        <table id="datatable" class="table table-primary table-bordered table-striped table-hover dt-responsive">
